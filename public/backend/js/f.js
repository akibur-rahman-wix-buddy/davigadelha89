...
if ($("#pageWrapper").hasClass("compact-wrapper")) {
    ...
    // Auto-expand active sidebar and submenu on page load
    $(".sidebar-title.active").each(function () {
        $(this).find("div").replaceWith('<div class="according-menu"><i class="fa fa-angle-down"></i></div>');
        $(this).next(".sidebar-submenu, .menu-content").slideDown();
    });

    $(".submenu-title.active").each(function () {
        $(this).find("div").replaceWith('<div class="according-menu"><i class="fa fa-angle-down"></i></div>');
        $(this).next(".submenu-content").slideDown();
    });
} else if ($("#pageWrapper").hasClass("horizontal-wrapper")) {
    $(window).on("load", function () {
        $(document).load($(window).bind("resize", checkPosition));
