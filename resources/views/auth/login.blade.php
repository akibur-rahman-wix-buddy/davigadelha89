...
<head>
    ...
    <meta charset="utf-8">
    <title>Sign In | Slee Safe Baby</title>
    ...
    <div class="relative">
        ...
        <div class="mb-0 w-screen lg:mx-auto lg:w-[500px] card shadow-lg border-none shadow-slate-100 relative">
            <div class="!px-10 !py-12 card-body">
                <a href="#!">
                    <img src="{{ $data->logo }}" alt="" class="hidden h-12 mx-auto dark:block">
                    <img src="{{ $data->logo }}" alt="" class="block h-18 mx-auto dark:hidden">
                </a>

                <div class="mt-8 text-center">
                    <h4 class="mb-1 text-custom-500 dark:text-custom-500">Welcome Back !</h4>
                    <p class="text-slate-500 dark:text-zink-200">Sign in to continue to Sleep Safe Baby.</p>
                </div>
